...
class DetailRemoteSourceImpl
    ...
    constructor(
        ...
        override suspend fun getVacancyRemote(id: String): DetailResponseDto =
            withContext(dispatchersProvider.io) {
                ...
                val jsonAdapter: JsonAdapter<DetailResponseDto> = moshi.adapter(DetailResponseDto::class.java)
                jsonAdapter.fromJson(jsonString) ?: throw Exception("Ошибка при парсинге")
            }
    }
