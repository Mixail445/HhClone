...
class SearchRemoteSourceImpl
    ...
    constructor(
        ...
        override suspend fun getVacancyRemote(): SearchResponseDto =
//        withContext(dispatchersProvider.io) {
//            listOf(api.getVacancy())
            withContext(dispatchersProvider.io) {
                val jsonString =
                    """
                    {
                ...
                val type = Types.newParameterizedType(List::class.java, SearchResponseDto::class.java)
                val jsonAdapter: JsonAdapter<SearchResponseDto> = moshi.adapter(SearchResponseDto::class.java)
